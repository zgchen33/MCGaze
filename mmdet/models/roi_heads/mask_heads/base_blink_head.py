...
class BaseBlinkHead(BaseModule):
    ...
    def __init__(self,
        ...
        super(BaseBlinkHead, self).__init__(init_cfg)
        ...
        self.loss_mask = build_loss(loss_blink)
    ...
    def init_weights(self):
        super(BaseBlinkHead, self).init_weights()
    ...
    def loss(self, mask_pred, mask_targets, labels):
        ...
        Example:
            ...
            >>> self = BaseBlinkHead(num_classes=C, num_convs=1)
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
        ...
        Example:
            ...
            >>> C, H, W = 11, 32, 32
            >>> # Create example instance of FCN Mask Head.
            >>> self = BaseBlinkHead(num_classes=C, num_convs=0)
            >>> inputs = torch.rand(N, self.in_channels, H, W)
            >>> mask_pred = self.forward(inputs)
