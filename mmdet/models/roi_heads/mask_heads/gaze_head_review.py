...
class GazeHead(BaseModule):
    ...
    def __init__(self,
        ...
        self.fc_gaze = nn.Linear(in_channels * 2, 3)
    ...
    @auto_fp16()
    def forward(self, proposal_face_feat, proposal_head_feat):
        ...
        '''
        gaze_face_feat = copy.deepcopy(proposal_face_feat)
        gaze_head_feat = copy.deepcopy(proposal_head_feat)
