...
class TeViTRoIHead(SparseRoIHead):
    def __init__(self, *args, **kwargs):
        super(TeViTRoIHead, self).__init__(*args, **kwargs)
        ...
        for stage in range(self.num_stages):    # 开始迭代
            ...
            if self.with_mask:
                mask_results = self._mask_forward_train(
                    stage, x, bbox_results['object_feats'], sampling_results,
                    gt_blinks, self.train_cfg[stage]) # 这里改了来做消融实验
                single_stage_loss['loss_blink'] = mask_results['loss_blink']
    ...
    def simple_test(self,
        ...
        if self.with_mask:
            ...
            blink_results = self._mask_forward(stage, x, rois, attn_feats)
